...
class MistralForCompressedCausalLMLingua(MistralForCausalLM):
    def __init__(self, config: MistralConfig, tokenizer_name, split_size, target_token):  # changed by GC
